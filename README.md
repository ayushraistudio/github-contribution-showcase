...
A GitHub **GraphQL-based Trophy API** that displays a user’s real GitHub name
(or username if no name is set), along with **accurate contribution streaks**,
**active days**, and **total contributions** — all shown in clean, polished SVG widgets.
...
Contributions help make the open-source community a great place to learn, build, and share.
